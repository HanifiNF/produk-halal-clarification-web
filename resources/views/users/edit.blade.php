                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" name="establish_year"
                                    class="block w-full mt-1 rounded-md border-gray-300 shadow-sm dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                                    value="{{ old('establish_year', $user->establish_year) }}" min="1900"
                                    max="{{ date('Y') }}">
                            </div>
                        </div>
                        @if(Auth::user()->admin)
                            <div class="mb-4">
                                ...
                                <div class="flex items-center mb-2">
                                    <input type="radio" name="data_access" id="data_access_yes" value="1"
                                        class="rounded text-indigo-600 shadow-sm" {{ $user->data_access ? 'checked' : '' }}>
                            ...
                            <div class="mb-4">
                                ...
                                <select name="pembina" 
                                    ...
                                    <option value="Pembina A" {{ old('pembina', $user->pembina) == 'Pembina A' ? 'selected' : '' }}>Pembina A</option>
                                    <option value="Pembina B" {{ old('pembina', $user->pembina) == 'Pembina B' ? 'selected' : '' }}>Pembina B</option>
                                    <option value="Pembina C" {{ old('pembina', $user->pembina) == 'Pembina C' ? 'selected' : '' }}>Pembina C</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="flex items-center mb-2">
                                    <input type="radio" name="status_pembina" id="status_pembina_yes" value="1"
                                        class="rounded text-indigo-600 shadow-sm" {{ $user->status_pembina ? 'checked' : '' }}>

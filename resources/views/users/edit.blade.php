                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('users.update', $user) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="tel" name="phone_number" class="block w-full mt-1 rounded-md border-gray-300 shadow-sm dark:border-gray-600 dark:bg-gray-700 dark:text-white" value="{{ old('phone_number', $user->phone_number) }}">
                        </div>
                        <div class="mb-4">

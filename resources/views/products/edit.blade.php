                            ...
                            <div class="mb-4">
                                ...
                                <div class="flex items-center mb-2">
                                    <input type="radio" name="verification_status" id="verification_status_approved" value="1"
                                        class="rounded text-indigo-600 shadow-sm" {{ old('verification_status', $product->verification_status) == '1' ? 'checked' : '' }}>
                                ...
                                <div class="flex items-center">
                                    <input type="radio" name="verification_status" id="verification_status_pending" value="0"
                                        class="rounded text-indigo-600 shadow-sm" {{ old('verification_status', $product->verification_status) == '0' ? 'checked' : '' }}>

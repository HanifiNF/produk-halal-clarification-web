                ...
                <div class="bg-white dark:bg-white overflow-hidden shadow-lg sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-700">
                        ...
                        <div class="mt-8">
                            ...
                            @else
                                <p class="text-gray-800 dark:text-gray-700">YKamu belum mempunyai produk.</p>
                                <a href="{{ route('products.create') }}"
                            ...
                            <div class="mt-8">
                                ...
                                @if($binaan->count() > 0)
                                    ...
                                    <div class="mt-4">
                                        <a href="{{ route('pembina.binaan') }}"
                                            class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300">
                                            Lihat Semua Binaan &rarr;
                                        </a>
                                    </div>
                                @else
                                    <p class="text-gray-800 dark:text-gray-200">Anda belum mempunyai Binaan.</p>
                                @endif
                            </div>
                        @endif
                    </div>
